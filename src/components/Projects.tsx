        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="group bg-gradient-to-br from-slate-800/60 to-slate-900/60 rounded-3xl border border-slate-700/50 hover:border-cyan-500/50 transition-all duration-500 overflow-hidden hover:transform hover:scale-105 hover:shadow-2xl hover:shadow-cyan-500/20 backdrop-blur-sm">
            <div className="p-12">
              <div className="flex items-center mb-8">
                <div className="w-16 h-16 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-2xl flex items-center justify-center mr-6 group-hover:scale-110 transition-transform duration-500">
                ...
                <div>
                  ...
                  <p className="text-cyan-400 font-medium text-lg">Team Leader & Technical Lead</p>
                </div>
              </div>
              ...
              <div className="mb-10">
                ...
                <div className="flex flex-wrap gap-4">
                  {["Raspberry Pi", "Sensors", "Cameras", "Wireless Communication", "Mobile App", "Security Protocols"].map((tech) => (
                    <span key={tech} className="bg-gradient-to-r from-slate-700/60 to-slate-800/60 text-cyan-400 px-6 py-3 rounded-full border border-slate-600/50 hover:border-cyan-500/50 hover:bg-cyan-500/10 transition-all duration-300 transform hover:scale-105">
                      {tech}
                    </span>
                  ))}
                </div>
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {[
                  ...
                  <div key={item.title} className="text-center p-6 bg-gradient-to-br from-slate-700/40 to-slate-800/40 rounded-xl border border-slate-600/30 hover:border-cyan-500/50 transition-all duration-300 hover:transform hover:scale-105 group/card">
                    <div className="text-3xl mb-3 group-hover/card:scale-110 transition-transform duration-300">
                      {item.icon}
                    </div>
                    <div className="text-2xl text-cyan-400 font-bold mb-1 group-hover/card:text-cyan-300 transition-colors duration-300">
                      {item.title}
                    </div>
                    <div className="text-gray-400 text-sm group-hover/card:text-gray-300 transition-colors duration-300">
                      {item.subtitle}
                    </div>
                  </div>
                ))}
              ...
              <div className="mt-10 flex justify-center space-x-6">
                <button className="bg-gradient-to-r from-cyan-500 to-blue-500 text-white px-8 py-4 rounded-full hover:from-cyan-600 hover:to-blue-600 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-cyan-500/30">
                  View Details
                </button>
                <button className="border-2 border-cyan-500/50 text-cyan-400 px-8 py-4 rounded-full hover:bg-cyan-500/10 hover:border-cyan-400 transition-all duration-300 transform hover:scale-105">
                  GitHub Repository
                </button>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mt-16">
            {[
              ...
              <div key={project.title} className="group bg-gradient-to-br from-slate-800/40 to-slate-900/40 p-8 rounded-2xl border border-slate-700/30 hover:border-cyan-500/50 transition-all duration-500 hover:transform hover:scale-105 backdrop-blur-sm">
